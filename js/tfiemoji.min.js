...
// By Fayearth
!function(a,b){function c(){return!j.implementation.hasFeature||j.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")}function d(){if(!k){if(void 0===a.twemoji){if(i>600)return;return a.clearTimeout(h),h=a.setTimeout(d,50),void i++}g=a.twemoji,k=!0,f(j.body)}}function e(a){return"number"==typeof a?a+"x"+a:a}function f(a,d){var f;return g&&a&&("string"==typeof a||a.childNodes&&a.childNodes.length)?(f={base:b.base?b.base:g.base,ext:b.ext&&(c()?b.ext:g.ext)||g.ext,className:b.className||"emoji",size:b.folder||e(b.size||g.size),callback:function(a,b){switch(a){case"a9":case"ae":case"2122":return!1}return"".concat(b.base,b.size,"/",a,b.ext)},onerror:function(){g.parentNode&&g.parentNode.replaceChild(j.createTextNode(g.alt),g)}},g.parse(a,f)):a}var g,h,i=0,j=a.document,k=!1;b&&(b.DOMReady?d():b.readyCallback=d)}(window,window.fayemojiConfig);
